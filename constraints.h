...
public:
    ...
    void addStartConstraint(int i, int j, int size, std::vector<cell> cells, double agentsize = 0.5);
    void removeStartConstraint(std::vector<cell> cells, int start_i, int start_j);
